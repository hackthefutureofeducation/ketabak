...
const ModernButton = forwardRef<HTMLButtonElement, ModernButtonProps>(
  (
    { className = "", variant = "primary", isLoading = false, icon, children, disabled, isAddNewInSelect, type, ...props },
    ref
  ) => {
    const baseStyles =
    ...
    const variants = {
      ...
      ghost: "bg-transparent text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-slate-800 hover:text-gray-900 dark:hover:text-white",
    };
